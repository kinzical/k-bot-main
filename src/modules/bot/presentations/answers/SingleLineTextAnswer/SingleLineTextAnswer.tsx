...
type SingleLineTextAnswerProps = {
  data: ActivityVM;
};

const SingleLineTextAnswer: React.FC<SingleLineTextAnswerProps> = (
  props: SingleLineTextAnswerProps
) => {
  const { data } = props;
  const { answer } = data;
...
export default SingleLineTextAnswer;
